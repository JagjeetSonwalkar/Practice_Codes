...
int main()
{
    ...
    Singly_LL <double> sobj ;    // Object of LL

    sobj.InsertFirst(21.252525142);
    sobj.InsertFirst(20.302525142);
    sobj.InsertFirst(10.252525142);
    sobj.InsertFirst(1.222525142);

    iRet = sobj.Count();
    cout<<"Total elements in LL are : "<<iRet<<"\n";
    sobj.Display();

    sobj.InsertLast(30.112525142);
    sobj.InsertLast(31.242525142);
    sobj.InsertLast(32.252525142);
    sobj.InsertLast(11.112525142);
    ...
    sobj.InsertAtPos(0000.000000,4);
    sobj.InsertAtPos(1111.111111,5);
...
/*
    ...
    Elements of LL are :
    | 1.22253 |->| 10.2525 |->| 20.3025 |->| 21.2525 |-> NULL
    Total elements in LL are : 8
    Elements of LL are :
    | 1.22253 |->| 10.2525 |->| 20.3025 |->| 21.2525 |->| 30.1125 |->| 31.2425 |->| 32.2525 |->| 11.1125 |-> NULL
    Total elements in LL are : 7
    Elements of LL are :
    | 10.2525 |->| 20.3025 |->| 21.2525 |->| 30.1125 |->| 31.2425 |->| 32.2525 |->| 11.1125 |-> NULL
    Total elements in LL are : 6
    Elements of LL are :
    | 10.2525 |->| 20.3025 |->| 21.2525 |->| 30.1125 |->| 31.2425 |->| 32.2525 |-> NULL
    Total elements in LL are : 8
    Elements of LL are :
    | 10.2525 |->| 20.3025 |->| 21.2525 |->| 0 |->| 1111.11 |->| 30.1125 |->| 31.2425 |->| 32.2525 |-> NULL
    Total elements in LL are : 7
    Elements of LL are :
    | 10.2525 |->| 20.3025 |->| 21.2525 |->| 0 |->| 30.1125 |->| 31.2425 |->| 32.2525 |-> NULL
