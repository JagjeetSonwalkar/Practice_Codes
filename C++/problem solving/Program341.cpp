...
class Singly_LL
{
    public:
        ...
        void InsertLast(int no)                 // Insert the node at Last of LL
        {
            PNODE newn = NULL ;             // new node 
        ...
        void InsertAtPos(int no , int iPos)                 // Insert the node at the position
        {
            int iCnt = 0 ;
...
int main()
{
    ...
    sobj.InsertAtPos(0000,4);
    sobj.InsertAtPos(1111,5);
...
/*
    ...
    Elements of LL are :
    | 1 |->| 10 |->| 20 |->| 21 |->| 30 |->| 31 |->| 32 |->| 11 |-> NULL
    Total elements in LL are : 7
    Elements of LL are :
    | 10 |->| 20 |->| 21 |->| 30 |->| 31 |->| 32 |->| 11 |-> NULL
    Total elements in LL are : 6
    Elements of LL are :
    | 10 |->| 20 |->| 21 |->| 30 |->| 31 |->| 32 |-> NULL
    Total elements in LL are : 8
    Elements of LL are :
    | 10 |->| 20 |->| 21 |->| 0 |->| 1111 |->| 30 |->| 31 |->| 32 |-> NULL
    Total elements in LL are : 7
    Elements of LL are :
    | 10 |->| 20 |->| 21 |->| 0 |->| 30 |->| 31 |->| 32 |-> NULL
