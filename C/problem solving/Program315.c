...
void DeleteAtPos(PPNODE head , int no , int iPos)            // Call by Address
{
    int iCountNode = 0 ;
...
int main()
{
    ...
    InsertAtPos(&first,01,1);

    Display(first);
    iRet = Count(first);
    printf("Number of Elements in LinkedList are : %d \n",iRet);

    InsertAtPos(&first,02,8);
...
/*
    ...
    | 111 |->| 21 |->| 31 |->| 51 |->| 101 |->| 201 |-> NULL
    Number of Elements in LinkedList are : 6
    | 1 |->| 111 |->| 21 |->| 31 |->| 51 |->| 101 |->| 201 |-> NULL
    Number of Elements in LinkedList are : 7
    | 1 |->| 111 |->| 21 |->| 31 |->| 51 |->| 101 |->| 201 |->| 2 |-> NULL
    Number of Elements in LinkedList are : 8
    | 1 |->| 111 |->| 21 |->| 31 |->| 555 |->| 51 |->| 101 |->| 201 |->| 2 |-> NULL
    Number of Elements in LinkedList are : 9
