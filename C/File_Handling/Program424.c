/*
    Open the existing file and get the name of file from user also write 'Hello World' into the file in the end of last character and close the file and 
