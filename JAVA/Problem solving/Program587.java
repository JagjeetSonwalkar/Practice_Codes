...
find all maxmium element from rows , find all minimum element from rows , Sum the diagonal element of array , Sum the border element of array .
...
class Program587
{
    public static void main(String arg[])
    {
        ...
        int iRetDiagonalSum = 0 ;

        iRetDiagonalSum = mobj.SumDiagonal();

        System.out.println("Sum of diagonal values are : "+iRetDiagonalSum);

        int iRetBorderSum = 0 ;

        iRetBorderSum = mobj.SumBorder();
        System.out.println("Sum of Border values are : "+iRetBorderSum);
    }
}
...
1       1       1       1
1       1       1       1
Sum of diagonal values are : 4
Sum of Border values are : 12
